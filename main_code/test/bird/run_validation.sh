...
version_name="bird"
exp_name="final"
log_file="your_code_path/output/test/bird/${exp_name}/iqa_results.log"
...
python ./validation_reference.py \
    ...
    --base_config your_code_path/main_code/test/bird/validation.yaml \
    --output_dir your_code_path/output/test/bird/ \
...
python ./cal_iqa.py --img_path your_code_path/output/test/bird/${exp_name}/pred_images --gt_path your_code_path/data/bird/gt >> $log_file 2>&1
